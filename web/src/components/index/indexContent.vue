  ...
  <div id="indexContent">
    <div class="content">
      <div class="list" v-for="(item, index) in listData" :key="index">
        ...
        <el-button
          style="position: relative; left: -235px; top: 35px"
          type="info"
          display="inline-block"
        ...
        <el-button
          style="position: relative; left: -230px; top: 35px"
          display="inline-block"
          type="primary"
      ...
      <!-- <div class="list"></div>
      <div class="list"></div> -->
      <el-dialog title="聊天框" :visible.sync="dialogVisible" width="80%">
...
export default {
  ...
  methods: {
    ...
    isRed() {
      //console.log(777)
      var _self = this;
      var url = "http://localhost:8080/hasReadNotice";
      _self.$axios
        .get(url)
        .then((res) => {
          if (res.status == 200) {
    ...
    guanzhuList() {
      var _self = this;
      var url = "http://localhost:8080/follow/list";
    ...
    guanzhu(userId) {
      ...
      //console.log(userId);
      var _self = this;
      var url = "http://localhost:8080/add/follow";
      //var categoryId = this.id;
    ...
    noguanzhu(userId) {
      ...
      //console.log(userId);
      var _self = this;
      var url = "http://localhost:8080/cancel/follow";
      //var categoryId = this.id;
