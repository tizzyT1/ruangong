...
export default {
  ...
  methods: {
    ...
    changeArt1() {
      ...
      var _self = this;
      var articleId = parseInt(_self.artId);
      var url = "http://localhost:8080/article/can/edit";
    ...
    deleteArt() {
      var _self = this;
      var articleId = parseInt(_self.artId);
      var url = "http://localhost:8080/article/delete";
    ...
    submitComment() {
      ...
      var articleId = parseInt(_self.artId);
      //console.log(params)
      var url = "http://localhost:8080/insert/comment";
    ...
    getData(id) {
      var _self = this;
      var url = "http://localhost:8080/detail/";
      let articleId;
      if (id) {
        articleId = id;
      } else {
    ...
    getComment() {
      var _self = this;
      var url = "http://localhost:8080/comment/list";
      var articleId = parseInt(_self.artId);
      _self.$axios
        .get(url, {
          params: {
    ...
    getHotPot() {
      var _self = this;
      var url = "http://localhost:8080/article/hotspot";
