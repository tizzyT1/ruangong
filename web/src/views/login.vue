        ...
        <div class="phone">
          <div class="sjh">
            ...
            >
              ...
              <div class="images">
                <a href="http://localhost:8080/oauth/login">
                  <img src="@/assets/1.png" alt="" href="">
                </a>
                <a href="http://localhost:8080/oauth/qq">
...
export default {
  ...
  methods: {
    ...
    getCheckPass() {
      var _self = this;
      var url = "http://localhost:8080/login/sendSMSCode";
    ...
    submitForm(formName) {
      ...
      const url = "http://localhost:8080/login/verifyLoginInfo";
